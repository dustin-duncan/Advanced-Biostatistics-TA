...
For this code, sample is pulling random values from a vector. The vector is p_grid, and the probability of each value comes from the posterior, which we just computed. 
